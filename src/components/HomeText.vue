<script setup>
const title =
  "Hi, I’m Léon Tran-Van. I’m currently working as a front-end developer at Hager, a leading supplier of solutions and services for electrical installations.";
